  ...
  /******/ [
    ...
    /***/ function (module, exports) {
          ...
          var run = function () {
            ...
            that.glowMaterial = new THREE.ShaderMaterial({
              uniforms: {
                ...
                glowColor: {
                  type: "c",
                  value: new THREE.Color(that.data.color),
                },
        ...
        resize: function (new_size) {
          ...
          if (new_size < this.length) {
            ...
            if (this.buffer.length < new_size * this.unit_size) {
              ...
              nBuffer = new this.array_type(new_size * this.unit_size);
              nBuffer.set(
                this.buffer.subarray(0, this.length * this.unit_size)
              );
              this.buffer = nBuffer;
              this.real_length = new_size;
            }
      ...
      function compute_vertex_normals(geometry) {
        ...
        var oldFaces = new TypedArrayHelper(
          0,
          3,
          THREE.Face3,
          Uint32Array,
        ...
        for (var i = 0, il = oldFaces.length; i < il; i++) {
          ...
          full_weights[0] =
            my_weight / newNormalFaces.buffer[oldFaces.register[0].a];
          full_weights[1] =
            my_weight / newNormalFaces.buffer[oldFaces.register[0].b];
          full_weights[2] =
            my_weight / newNormalFaces.buffer[oldFaces.register[0].c];
      ...
      function unIndexIndexedGeometry(geometry) {
        ...
        var oldUvs = new TypedArrayHelper(
          0,
          3,
          THREE.Vector2,
          Float32Array,
        ...
        if (newUvs.length !== 0) {
          geometry.addAttribute(
            "uv",
            new THREE.BufferAttribute(newUvs.buffer, 2)
          );
        }
        ...
        THREE.BufferSubdivisionModifier.prototype.smooth = function (geometry) {
          ...
          for (i = 0, il = oldVertices.length; i < il; i++) {
            ...
            for (j = 0; j < n; j++) {
              ...
              other =
                connectingEdge.a !== i ? connectingEdge.a : connectingEdge.b;
