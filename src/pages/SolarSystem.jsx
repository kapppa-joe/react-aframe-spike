...
const getModelFilePath = (model_name) => {
  return Models[model_name].default;
};
      ...
      >
        <Entity
          ...
          detect-click={{
            onClick: (e) => {
              setMessage(
                `you have clicked the ${e.target.id.replace(/-\w+/, "")}`
              );
            },
            onMouseEnter: (e) => {
        ...
        >
          {model_name === "earth" && <Moon setMessage={setMessage} />}
          <Entity
...
const SolarSystem = () => {
  ...
  const [message, setMessage] = useState("(placeholder for message)");
  ...
  return (
    <>
      ...
      {message && (
        <div
          style={{ border: "0.5px solid #ccc;", padding: "1em", color: "#FFC" }}
        >
          {message}
        </div>
      )}
      ...
      >
        ...
        <Entity
          ...
          detect-click={{
            onClick: (e) => {
              setMessage(`you have clicked the ${e.target.id}`);
            },
          }}
        ></Entity>
